...
def create_entry(self, label_text, y_position):
...
def pwd_entry(self, label_text, y_position, show_var=None):
    ctk.CTkLabel(self.master, text=label_text, fg_color="black", bg_color="black",
                 font=("Helvetica", 15), padx=20).place(x=35, y=y_position)
